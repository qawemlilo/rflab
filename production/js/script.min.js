...
!function(){function e(){var e=document.getElementById("software"),t=document.createElement("a"),n=location.href;t.href=n,"/software"===t.pathname&&(e.className="active")}function t(){var e=this,t=$(".progress"),n=$("#responseD");return t.slideDown(function(){$.post("/contact",$(e).serialize()+"&access_token="+(new Date).getTime()).done(function(s){e.reset(),t.slideUp(function(){n.addClass("alert-success").html($("<strong>"+s+"</strong>")).slideDown("slow")}),window.setTimeout(function(){n.slideUp(function(){n.removeClass("alert-success")})},1e4)}).fail(function(s){e.reset(),t.slideUp(function(){n.addClass("alert-error").html($("<strong>"+s+"</strong>")).slideDown()}),window.setTimeout(function(){n.slideUp(function(){n.removeClass("alert-error")})},1e4)})}),!1}$("#contactme").on("submit",t),e()}();